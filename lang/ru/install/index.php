<?php
$MESS ["ITTOWER_SIMPLEPROPS_MODULE_DESC"] = "Позволяет редактирование значений свойств инфоблоков в списке, при режиме
 использования параметров свойств в компонентах и формах.";
$MESS ["ITTOWER_SIMPLEPROPS_MODULE_NAME"] = "Управление свойствами инфоблока";
